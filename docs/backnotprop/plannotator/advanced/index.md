---
title: "Advanced: Collaboration & Integration | plannotator"
sidebarTitle: "Advanced"
subtitle: "Advanced: Collaboration & Integration"
description: "Explore Plannotator's advanced features including URL sharing, note app integration, remote development support, and flexible environment configuration."
order: 3
---
...
- [Quick Start](../start/getting-started/): Understand the basic concepts of Plannotator
- [Plan Review Basics](../platforms/plan-review-basics/): Master basic plan review operations
:::
...
| [Remote Mode](./remote-mode/) | Use Plannotator in remote environments like SSH, devcontainer, WSL | Remote development scenarios |
| [Environment Variables](./environment-variables/) | Learn all available environment variables and their purposes | Need to customize Plannotator behavior |
...
- View [Common Problems](../faq/common-problems/): Solve problems encountered during use
- View [API Reference](../appendix/api-reference/): Understand Plannotator's complete API
- View [Data Models](../appendix/data-models/): Deep dive into internal data structures
