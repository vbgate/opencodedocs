---
title: "代码评审: Git Diff 可视化审查 | plannotator"
sidebarTitle: "评审 Agent 改的代码"
subtitle: "代码评审: Git Diff 可视化审查"
description: "学习 Plannotator 的代码评审功能。使用可视化界面评审 Git Diff，在 side-by-side 和 unified 视图间切换，添加行级注释，并将反馈发送给 AI Agent。"
tags:
  - "代码评审"
  - "Git Diff"
  - "行级注释"
...
**代码评审**是 Plannotator 提供的可视化 Git Diff 评审工具，让你在浏览器中查看代码变更并添加行级注释。
