---
title: "隐藏模式: 宽度计算原理 | opencode-md-table-formatter"
sidebarTitle: "宽度计算三步走"
subtitle: "隐藏模式原理：为什么宽度计算如此重要"
description: "学习 OpenCode 隐藏模式的工作原理。掌握插件显示宽度计算方法，了解 Markdown 符号剥离、代码块保护、Bun.stringWidth 的使用。"
tags:
  - "concealment-mode"
  - "显示宽度计算"
  - "Markdown 符号剥离"
...
OpenCode 默认开启**隐藏模式（Concealment Mode）**，它会在渲染时隐藏 Markdown 语法符号：
...
- [ ] `Bun.stringWidth` 比 `text.length` 好在哪？（答：能正确计算中文、Emoji、零宽字符的显示宽度）
...
| 功能 | 文件路径 | 行号 |
| --- | --- | --- |
| 显示宽度计算入口 | [`index.ts`](https://github.com/franlol/opencode-md-table-formatter/blob/main/index.ts#L151-L159) | 151-159 |
| 代码块保护 | [`index.ts`](https://github.com/franlol/opencode-md-table-formatter/blob/main/index.ts#L168-L173) | 168-173 |
| Markdown 符号剥离 | [`index.ts`](https://github.com/franlol/opencode-md-table-formatter/blob/main/index.ts#L175-L188) | 175-188 |
| 代码块恢复 | [`index.ts`](https://github.com/franlol/opencode-md-table-formatter/blob/main/index.ts#L190-L193) | 190-193 |
| Bun.stringWidth 调用 | [`index.ts`](https://github.com/franlol/opencode-md-table-formatter/blob/main/index.ts#L195) | 195 |
