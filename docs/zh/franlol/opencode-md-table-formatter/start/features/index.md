---
title: "功能全览: 8 大核心功能 | opencode-md-table-formatter"
sidebarTitle: "8 大功能一览"
subtitle: "功能全览: 8 大核心功能"
description: "学习 opencode-md-table-formatter 插件的 8 大核心功能。掌握自动表格格式化、隐藏模式兼容和对齐支持，快速处理 Emoji 和 Unicode。"
tags:
  - "自动格式化"
  - "隐藏模式"
  - "对齐支持"
...
> 下一课我们深入 **[隐藏模式原理](../../advanced/concealment-mode/)**。
>
> 你会学到：
> - OpenCode 隐藏模式的工作原理
> - 插件如何正确计算显示宽度
...
| 表格检测 | [`index.ts`](https://github.com/franlol/opencode-md-table-formatter/blob/main/index.ts#L58-L61) | 58-61 |
| 表格验证 | [`index.ts`](https://github.com/franlol/opencode-md-table-formatter/blob/main/index.ts#L70-L88) | 70-88 |
| 宽度计算（隐藏模式） | [`index.ts`](https://github.com/franlol/opencode-md-table-formatter/blob/main/index.ts#L161-L196) | 161-196 |
