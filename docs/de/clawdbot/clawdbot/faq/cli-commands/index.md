---
title: "CLI-Befehlsreferenz: Vollständige Befehlsliste und Verwendung | Clawdbot-Tutorial"
sidebarTitle: "Befehle nicht gefunden"
subtitle: "CLI-Befehlsreferenz: Vollständige Befehlsliste und Verwendungsanweisungen"
description: "Lernen Sie die vollständige Referenz aller CLI-Befehle von Clawdbot, einschließlich detaillierter Verwendung, Optionenerklärungen und praktischer Beispiele für 24 Befehlsgruppen wie Gateway, Agent, Models, Channels, Nodes, Skills usw. Finden Sie schnell die Verwendung und Parameter beliebiger CLI-Befehle, lernen Sie komplexe Befehle durch Beispiele und verwalten Sie effektiv Gateway, Agent, Kanäle, geplante Aufgaben, Geräteknoten, Fähigkeitspakete und Browser-Automatisierung."
tags:
  - "CLI"
  - "Befehlsreferenz"
  - "FAQ"
