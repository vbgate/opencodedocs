---
title: "メモリシステムとベクトル検索の完全ガイド | Clawdbot チュートリアル"
sidebarTitle: "メモリ検索の設定"
subtitle: "メモリシステムとベクトル検索の完全ガイド"
description: "Clawdbot メモリシステムの仕組みを学びます。ベクトルインデックス、FTS5全文検索、ハイブリッド検索、Embeddingプロバイダーの設定について。AIの長期記憶の設定と使用方法を習得し、セマンティック検索の精度を向上させます。"
tags:
  - "memory"
  - "vector-search"
  - "embedding"
