---
title: "CLIコマンドリファレンス：完全なコマンドリストと使用法 | Clawdbotチュートリアル"
sidebarTitle: "コマンドが見つからない"
subtitle: "CLIコマンドリファレンス：完全なコマンドリストと使用法"
description: "ClawdbotのすべてのCLIコマンドの完全なリファレンスを学びます。gateway、agent、models、channels、nodes、skillsなど24のコマンドグループの詳細な使用法、オプション説明、実践的な例を含みます。任意のCLIコマンドの使用法とパラメータを迅速に検索し、例を通じて複雑なコマンドを素早く習得し、Gateway、Agent、チャネル、定時タスク、デバイスノード、スキルパッケージ、ブラウザ自動化を効率的に管理します。"
tags:
  - "CLI"
  - "コマンドリファレンス"
  - "FAQ"
