---
title: "Referencia de Comandos CLI: Lista completa de comandos y uso | Tutorial de Clawdbot"
sidebarTitle: "Comandos no encontrados"
subtitle: "Referencia de Comandos CLI: Lista completa de comandos e instrucciones de uso"
description: "Aprende la referencia completa de todos los comandos CLI de Clawdbot, incluyendo uso detallado, explicaciones de opciones y ejemplos prácticos para 24 grupos de comandos como gateway, agent, models, channels, nodes, skills, etc. Encuentra rápidamente el uso y parámetros de cualquier comando CLI, aprende comandos complejos a través de ejemplos y gestiona eficazmente Gateway, Agent, canales, tareas programadas, nodos de dispositivo, paquetes de habilidades y automatización de navegador."
tags:
  - "CLI"
