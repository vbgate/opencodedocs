---
title: "功能全覽：8 大核心功能 | opencode-md-table-formatter"
sidebarTitle: "8 大功能一覽"
subtitle: "功能全覽：8 大核心功能"
description: "學習 opencode-md-table-formatter 外掛的 8 大核心功能。掌握自動表格格式化、隱藏模式相容和對齊支援，快速處理 Emoji 和 Unicode。"
tags:
  - "自動格式化"
  - "隱藏模式"
  - "對齊支援"
...
> 下一課我們深入 **[隱藏模式原理](../../advanced/concealment-mode/)**。
>
> 你會學到：
> - OpenCode 隱藏模式的工作原理
> - 外掛如何正確計算顯示寬度
...
| 表格檢測 | [`index.ts`](https://github.com/franlol/opencode-md-table-formatter/blob/main/index.ts#L58-L61) | 58-61 |
| 表格驗證 | [`index.ts`](https://github.com/franlol/opencode-md-table-formatter/blob/main/index.ts#L70-L88) | 70-88 |
| 寬度計算（隱藏模式） | [`index.ts`](https://github.com/franlol/opencode-md-table-formatter/blob/main/index.ts#L161-L196) | 161-196 |
| 對齊方式解析 | [`index.ts`](https://github.com/franlol/opencode-md-table-formatter/blob/main/index.ts#L141-L149) | 141-149 |
| 程式碼保護 | [`index.ts`](https://github.com/franlol/opencode-md-table-formatter/blob/main/index.ts#L168-L173) | 168-173 |
