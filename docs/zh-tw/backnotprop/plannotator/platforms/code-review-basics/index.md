---
title: "程式碼審查: Git Diff 視覺化審查 | plannotator"
sidebarTitle: "審查 Agent 改的程式碼"
subtitle: "程式碼審查: Git Diff 視覺化審查"
description: "學習 Plannotator 的程式碼審查功能。使用視覺化介面審查 Git Diff，在 side-by-side 和 unified 檢視間切換，新增行級註解，並將回饋傳送給 AI Agent。"
tags:
  - "程式碼審查"
  - "Git Diff"
  - "行級註解"
...
**程式碼審查**是 Plannotator 提供的視覺化 Git Diff 審查工具，讓你在瀏覽器中檢視程式碼變更並新增行級註解。
