---
title: "圖像標註: 三種工具標註 | Plannotator"
sidebarTitle: "三種工具標註圖片"
subtitle: "圖像標註: 三種工具標註"
description: "學習 Plannotator 圖像標註的三大工具。在計畫審查中附加圖片，使用畫筆、箭頭、圓形標註，支援調整顏色和快捷鍵操作。"
tags:
  - "圖像標註"
  - "畫筆"
  - "箭頭"
...
- ✅ 完成了 [計畫審查基礎](../plan-review-basics/) 或 [程式碼審查基礎](../code-review-basics/)
- ✅ 知道如何開啟計畫審查或程式碼審查頁面
- ✅ 了解基本的註解操作
...
**為什麼**
Plannotator 的圖像標註功能整合在計畫審查和程式碼審查中。
...
**為什麼**
不同顏色可以區分不同類型的標註（如紅色表示錯誤，綠色表示建議）。
...
::: tip 儲存機制
- 如果**沒有繪製任何標註**，直接儲存原始圖片
- 如果**有標註**，將原始圖片和標註合併為一張新圖片
...
> 下一課我們學習 **[程式碼審查基礎](../code-review-basics/)**。
>
> 你會學到：
...
| 工具列元件     | [`packages/ui/components/ImageAnnotator/Toolbar.tsx`](https://github.com/backnotprop/plannotator/blob/main/packages/ui/components/ImageAnnotator/Toolbar.tsx#L1-L219) | 1-219   |
