---
title: "Referência de Comandos CLI: Lista completa de comandos e uso | Tutorial do Clawdbot"
sidebarTitle: "Comandos não encontrados"
subtitle: "Referência de Comandos CLI: Lista completa de comandos e instruções de uso"
description: "Aprenda a referência completa de todos os comandos CLI do Clawdbot, incluindo uso detalhado, explicações de opções e exemplos práticos para 24 grupos de comandos como gateway, agent, models, channels, nodes, skills, etc. Encontre rapidamente o uso e parâmetros de qualquer comando CLI, aprenda comandos complexos através de exemplos e gerencie eficazmente Gateway, Agent, canais, tarefas agendadas, nós de dispositivo, pacotes de habilidades e automação de navegador."
tags:
  - "CLI"
